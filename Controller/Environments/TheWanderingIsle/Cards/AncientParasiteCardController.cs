...
namespace Cauldron.TheWanderingIsle
{
    public class AncientParasiteCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction dd) => dd.DamageSource.Card.IsTarget && dd.DamageSource.Card.IsHero && !IsThisCardNextToCard(dd.DamageSource), this.NextToResponse, new TriggerType[] { TriggerType.MoveCard }, TriggerTiming.After);
