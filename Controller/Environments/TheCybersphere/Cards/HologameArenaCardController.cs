...
namespace Cauldron.TheCybersphere
{
    public class HologameArenaCardController : TheCybersphereCardController
    {
        ...
        public override void AddTriggers()
        {
			...
			AddTrigger<DestroyCardAction>((DestroyCardAction dca) => dca.CardToDestroy != null && dca.CardToDestroy.Card.IsEnvironmentTarget && dca.CardSource != null && dca.CardSource.Card.IsHero,
