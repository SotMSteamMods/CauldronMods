...
namespace Cauldron.HalberdExperimentalResearchCenter
{
    public class HalcyonCleanersCardController : TestSubjectCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            Func<DealDamageAction, bool> increaseCriteria = (DealDamageAction dd) => !base.IsChemicalTriggerInPlay() && dd.DamageSource != null && dd.DamageSource.IsSameCard(base.Card) && base.IsTestSubject(dd.Target);
