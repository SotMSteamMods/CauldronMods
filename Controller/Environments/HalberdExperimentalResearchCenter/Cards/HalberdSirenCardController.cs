...
namespace Cauldron.HalberdExperimentalResearchCenter
{
    public class HalberdSirenCardController : TestSubjectCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddFirstTimePerTurnRedirectTrigger((DealDamageAction dd) => !base.IsChemicalTriggerInPlay() && base.CanCardBeConsideredHighestHitPoints(dd.Target, (Card c) => c.IsTarget && c.IsHero && c.IsInPlayAndHasGameText), FirstTimeHeroDamage, TargetType.HighestHP, (Card c) => IsVillainTarget(c));
