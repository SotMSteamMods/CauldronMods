...
namespace Cauldron.StSimeonsCatacombs
{
    public class TwistingPassagesCardController : StSimeonsRoomCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            bool heroCriteria(DealDamageAction dd) => this.GetNumberOfEnvironmentTargetsInPlay() < 2 && dd.DamageSource != null && dd.DamageSource.Card.IsHero && dd.DamageSource.Card.IsTarget;
