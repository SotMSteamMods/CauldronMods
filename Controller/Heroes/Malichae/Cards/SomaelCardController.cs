...
namespace Cauldron.Malichae
{
    public class SomaelCardController : DjinnTargetCardController
    {
        ...
        private IEnumerator EndOfTurnReponse(PhaseChangeAction pca)
        {
            ...
            var coroutine = base.GameController.SelectCardAndStoreResults(this.DecisionMaker, SelectionType.ReduceDamageTaken, new LinqCardCriteria(c => c.IsInPlay && c.IsHero && c.IsTarget, "hero target"), storedResult, false, cardSource: GetCardSource());
