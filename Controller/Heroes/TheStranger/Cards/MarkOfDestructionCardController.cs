...
namespace Cauldron.TheStranger
{
    public class MarkOfDestructionCardController : RuneCardController
    {
        ...
        public MarkOfDestructionCardController(Card card, TurnTakerController turnTakerController) : base(card, turnTakerController, new LinqCardCriteria((Card c) => !c.IsHeroCharacterCard && !c.IsVillainCharacterCard, "non-Character card", false, false, null, null, false))
        {
        }
        ...
        public override void AddTriggers()
        {
			...
			base.AddTrigger<DealDamageAction>((DealDamageAction dd) => dd.Target == base.Card && dd.DamageSource != null && !dd.DamageSource.Card.IsHero && dd.DamageSource.Card.IsTarget, new Func<DealDamageAction, IEnumerator>(this.RedirectResponse), TriggerType.RedirectDamage, TriggerTiming.Before);
        }
