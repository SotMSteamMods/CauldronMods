...
namespace Cauldron.Cricket
{
    public class ReturnPulseCardController : CardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            IEnumerator coroutine = base.GameController.SelectTargetsAndDealDamage(base.HeroTurnTakerController, new DamageSource(base.GameController, base.CharacterCard), 1, DamageType.Sonic, 3, false, 0, additionalCriteria: (Card c) => !c.IsHero, storedResultsDamage: targets);
