...
namespace Cauldron.Cricket
{
    public class AcousticDistortionCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction action) => !base.HasBeenSetToTrueThisTurn(FirstTimeWouldBeDealtDamage) && action.Target.IsHero, this.RedirectDamageResponse, isActionOptional: true, TriggerType.RedirectDamage, TriggerTiming.Before);
