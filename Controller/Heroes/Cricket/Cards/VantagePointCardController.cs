...
namespace Cauldron.Cricket
{
    public class VantagePointCardController : CardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            IEnumerator coroutine = base.EachPlayerMovesCards(0, 1, SelectionType.MoveCardToHandFromTrash, new LinqCardCriteria((Card c) => c.Identifier != base.Card.Identifier), (HeroTurnTaker htt) => htt.Trash, (HeroTurnTaker htt) => new MoveCardDestination(htt.Hand).ToEnumerable<MoveCardDestination>());
