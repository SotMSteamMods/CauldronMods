...
namespace Cauldron.Titan
{
    public class TheChaplainCardController : TitanCardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            IEnumerator coroutine = base.GameController.SelectTargetsAndDealDamage(base.HeroTurnTakerController, new DamageSource(base.GameController, base.CharacterCard), damageNumeral, DamageType.Projectile, targetNumeral, false, targetNumeral, cardSource: base.GetCardSource());
