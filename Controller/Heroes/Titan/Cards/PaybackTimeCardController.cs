...
namespace Cauldron.Titan
{
    public class PaybackTimeCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddIncreaseDamageTrigger((DealDamageAction action) => action.DamageSource.Card == base.CharacterCard && !action.Target.IsHero && this.HasTargetDealtDamageToTitanSinceHisLastTurn(action.Target), 1);
