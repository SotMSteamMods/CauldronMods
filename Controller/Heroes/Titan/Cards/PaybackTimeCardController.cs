...
namespace Cauldron.Titan
{
    public class PaybackTimeCardController : CardController
    {
        ...
        {
            base.SpecialStringMaker.ShowListOfCards(new LinqCardCriteria((Card c) => this.HasTargetDealtDamageToTitanSinceHisLastTurn(c), "targets who have dealt damge to Titan since the end of his last turn"));
        }
