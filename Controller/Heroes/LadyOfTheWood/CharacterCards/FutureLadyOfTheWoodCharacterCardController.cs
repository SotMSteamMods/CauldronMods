...
namespace Cauldron.LadyOfTheWood
{
	public class FutureLadyOfTheWoodCharacterCardController : HeroCharacterCardController
	{
		...
		private IEnumerator AddSpringResponse()
        {
			...
			OnDealDamageStatusEffect effect = new OnDealDamageStatusEffect(base.CardWithoutReplacements, "SpringGainHPReponse", "Whenever a hero deals toxic damage to a target, they regain that much HP.", new TriggerType[]
				{
				TriggerType.GainHP
		...
		private IEnumerator AddWinterResponse()
		{
			...
			OnDealDamageStatusEffect effect = new OnDealDamageStatusEffect(base.CardWithoutReplacements, "WinterDrawCardReponse", "Whenever a hero deals cold damage to a target, they draw a card.", new TriggerType[]
				{
		...
		private IEnumerator AddFallResponse()
		{
			...
			OnDealDamageStatusEffect effect = new OnDealDamageStatusEffect(base.CardWithoutReplacements, "FallReduceDamageReponse", "Whenever a hero deals lightning damage to a target, reduce damage dealt by that target by 1 until the start of your next turn.", new TriggerType[]
				{
