...
namespace SotMWorkshop.Controller.Anathema
{
	public class BiofeedbackCardController : CardController
    {
		...
		public override void AddTriggers()
		{
			...
			base.AddTrigger<DestroyCardAction>((DestroyCardAction dca) => this.IsArmHeadOrBody(dca.CardToDestroy.Card) && dca.CardSource.Card.IsTarget && dca.CardSource.Card.IsHero,
