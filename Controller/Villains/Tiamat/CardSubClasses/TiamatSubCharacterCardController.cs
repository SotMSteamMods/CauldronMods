...
{
    public class TiamatSubCharacterCardController : VillainCharacterCardController
    {
        public TiamatSubCharacterCardController(Card card, TurnTakerController turnTakerController) : base(card, turnTakerController)
        {
