...
namespace Cauldron.Oriphel
{
    public class WorldShardkeyCardController : OriphelShardkeyCardController
    {
        ...
        {
            IEnumerator coroutine = DealDamageToLowestHP(null, 1, (Card c) => c.IsHero, (c) => 2, DamageType.Melee, damageSourceInfo: new TargetInfo(HighestLowestHP.HighestHP, 1, 1, new LinqCardCriteria((Card c) => IsVillainTarget(c), "The villain target with the highest HP")));
