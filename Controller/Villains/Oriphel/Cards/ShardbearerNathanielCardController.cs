...
namespace Cauldron.Oriphel
{
    public class ShardbearerNathanielCardController : OriphelUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddIncreaseDamageTrigger((DealDamageAction dd) => dd.DamageSource != null &&  dd.DamageSource.IsCard && (IsGuardian(dd.DamageSource.Card) || dd.DamageSource.Card == oriphelIfInPlay), 1);
        }
    }
}