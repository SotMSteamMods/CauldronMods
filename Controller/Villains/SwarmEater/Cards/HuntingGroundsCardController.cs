...
namespace Cauldron.SwarmEater
{
    public class HuntingGroundsCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddReduceDamageTrigger((DealDamageAction action) => action.Target == base.CharacterCard && action.DamageSource.IsEnvironmentTarget, (DealDamageAction action) => 1);
            //Increase damage dealt by {SwarmEater} to environment targets by 1.
            base.AddIncreaseDamageTrigger((DealDamageAction action) => action.Target.IsEnvironmentTarget && action.DamageSource.Card == base.CharacterCard, 1);
