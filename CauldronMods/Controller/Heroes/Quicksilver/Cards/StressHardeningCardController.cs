...
namespace Cauldron.Quicksilver
{
    public class StressHardeningCardController : QuicksilverBaseCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddIncreaseDamageTrigger((DealDamageAction action) => action.DamageSource != null && action.DamageSource.Card != null && action.DamageSource.Card == base.CharacterCard && !IsHeroTarget(action.Target), _ => DamageIncrease());
        }
