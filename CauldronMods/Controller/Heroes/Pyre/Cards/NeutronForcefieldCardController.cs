...
namespace Cauldron.Pyre
{
    public class NeutronForcefieldCardController : PyreUtilityCardController
    {
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            var decision = new SelectCardDecision(GameController, DecisionMaker, SelectionType.PreventDamage, GameController.GetAllCards().Where((Card c) => c.IsInPlayAndHasGameText && c.IsTarget && c.IsHero && GameController.IsCardVisibleToCardSource(c, GetCardSource())), cardSource: GetCardSource());
