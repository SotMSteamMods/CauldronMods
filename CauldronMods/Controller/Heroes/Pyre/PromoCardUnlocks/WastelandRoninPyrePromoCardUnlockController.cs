...
{
    public class WastelandRoninPyrePromoCardUnlockController : PromoCardUnlockController
    {

        public WastelandRoninPyrePromoCardUnlockController(GameController gameController) : base(gameController, "Cauldron.Pyre", "WastelandRoninPyreCharacter")
        {
