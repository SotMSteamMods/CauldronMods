...
{
    public class WastelandRoninImpactPromoCardUnlockController : PromoCardUnlockController
    {

        public WastelandRoninImpactPromoCardUnlockController(GameController gameController) : base(gameController, "Cauldron.Impact", "WastelandRoninImpactCharacter")
        {
