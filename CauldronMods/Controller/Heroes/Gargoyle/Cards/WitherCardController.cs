...
namespace Cauldron.Gargoyle
{
    public class WitherCardController : GargoyleUtilityCardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            // Destroy 1 ongoing or environment card.
            coroutine = base.GameController.SelectAndDestroyCards(DecisionMaker, new LinqCardCriteria((card) => (card.IsEnvironment || card.IsOngoing) && card.IsInPlay), 1, false, 1, storedResultsAction: storedResults, cardSource: base.GetCardSource());
