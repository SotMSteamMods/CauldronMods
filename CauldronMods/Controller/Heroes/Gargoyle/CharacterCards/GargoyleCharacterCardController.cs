...
namespace Cauldron.Gargoyle
{
    public class GargoyleCharacterCardController : HeroCharacterCardController
    {
        ...
        {
            //base.AddTrigger<PhaseChangeAction>((pca) => pca.FromPhase == null, (pca) => base.SearchForCards(this.DecisionMaker, true, false, 1, 1, cardCriteria: new LinqCardCriteria((card) => "AbsorbAndUnleash" == card.Identifier), false, true, false, autoDecideCard: true), TriggerType.PhaseChange, TriggerTiming.After);
