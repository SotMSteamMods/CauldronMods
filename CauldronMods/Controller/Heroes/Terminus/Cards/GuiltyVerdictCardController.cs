...
namespace Cauldron.Terminus
{
    public class GuiltyVerdictCardController : TerminusBaseCardController
    {
        ...
        {
            base.AddTrigger<DealDamageAction>((dda) => IsHeroTarget(dda.Target) && dda.IsSuccessful && dda.Amount >= 3 && !dda.IsPretend, StoreIsHero, TriggerType.HiddenLast, TriggerTiming.Before);
