...
namespace Cauldron.Titan
{
    public class ImmolateCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction action) => action.DidDealDamage && action.DamageSource != null && action.DamageSource.Card != null && action.DamageSource.Card == base.GetCardThisCardIsNextTo() && !base.IsPropertyTrue(FirstTimeDealingDamage, null), this.DealDamageResponse, TriggerType.DealDamage, TriggerTiming.After);
