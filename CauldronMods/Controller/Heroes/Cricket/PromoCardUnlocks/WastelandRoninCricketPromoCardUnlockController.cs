...
{
    public class WastelandRoninCricketPromoCardUnlockController : PromoCardUnlockController
    {

        public WastelandRoninCricketPromoCardUnlockController(GameController gameController) : base(gameController, "Cauldron.Cricket", "WastelandRoninCricketCharacter")
        {
