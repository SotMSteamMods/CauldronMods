...
namespace Cauldron.MagnificentMara
{
    public class SmokeAndMirrorsCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dd) => IsHeroTarget(dd.Target) && dd.Amount > 0 && !this.IsBeingDestroyed, PreventDamageResponse, TriggerType.WouldBeDealtDamage, TriggerTiming.Before, isActionOptional: true);
        }
