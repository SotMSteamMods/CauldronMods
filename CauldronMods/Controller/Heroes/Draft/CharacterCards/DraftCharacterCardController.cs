...
{
    public class DraftCharacterCardController : HeroCharacterCardController
    {

        public DraftCharacterCardController(Card card, TurnTakerController turnTakerController) : base(card, turnTakerController)
        {
        }

        private CardController me => this as CardController;
        ...
        public override IEnumerator UsePower(int index = 0)
        {
            ...
            IEnumerator coroutine = base.SelectAndPerformFunction(base.HeroTurnTakerController, new Function[] {
                    new Function(base.HeroTurnTakerController, "Shift {ShiftLL}", SelectionType.RemoveTokens, () => me.ShiftLL()),
                    new Function(base.HeroTurnTakerController, "Shift {ShiftL}", SelectionType.RemoveTokens, () => me.ShiftL()),
                    new Function(base.HeroTurnTakerController, "Shift {ShiftR}", SelectionType.AddTokens, () => me.ShiftR()),
                    new Function(base.HeroTurnTakerController, "Shift {ShiftRR}", SelectionType.AddTokens, () => me.ShiftRR())
            });
