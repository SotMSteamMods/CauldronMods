...
namespace Cauldron.TheChasmOfAThousandNights
{
    public class ThievingCardController : NatureCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dd) => dd.DidDealDamage && GetCardThisCardIsBelow() != null && dd.DamageSource != null && dd.DamageSource.Card != null && dd.DamageSource.Card == GetCardThisCardIsBelow() && dd.Target != null && dd.Target.IsHero, DiscardCardResponse, TriggerType.DiscardCard, TriggerTiming.After);
            base.AddTriggers();
        }
