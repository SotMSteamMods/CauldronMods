...
namespace Cauldron.OblaskCrater
{
    public class OpenGroundCardController : OblaskCraterUtilityCardController
    {
        ...
        {
            base.AddTrigger<DealDamageAction>((dda)=> !base.IsPropertyTrue(FirstTimeWouldBeDealtDamage) && IsHeroTarget(dda.Target) && !dda.DamageSource.IsHeroTarget && dda.DamageSource.IsTarget, DealDamageActionResponse, new TriggerType[]
                {
