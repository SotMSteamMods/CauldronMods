...
namespace Cauldron.VaultFive
{
    public class TheOuterMusicCardController : VaultFiveUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<PlayCardAction>((PlayCardAction pca) => pca.CardToPlay != null && IsArtifact(pca.CardToPlay) && pca.CardToPlay.Owner.Identifier != pca.CardToPlay.ParentDeck.Identifier && pca.CardToPlay.Owner.IsHero && pca.Origin == pca.CardToPlay.Owner.ToHero().Hand, DestroyThisCardResponse, TriggerType.DestroySelf, TriggerTiming.After);
        }
    }
}
