...
namespace Cauldron.VaultFive
{
    public class ForbiddenKnowledgeCardController : VaultFiveUtilityCardController
    {
		...
		public override void AddTriggers()
        {
            ...
            AddEndOfTurnTrigger((TurnTaker tt) => tt.IsHero && !tt.IsIncapacitatedOrOutOfGame && DoesPlayerHaveArtifactInHand(tt.ToHero()), DealDamageHeroTurnResponse, TriggerType.DealDamage);
        }
