...
namespace Cauldron.StSimeonsCatacombs
{
    public class TwistingPassagesCardController : StSimeonsRoomCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            bool heroCriteria(DealDamageAction dd) => this.GetNumberOfEnvironmentTargetsInPlay() < 2 && dd.DamageSource != null && dd.DamageSource.Card != null && IsHeroTarget(dd.DamageSource.Card) && dd.DamageSource.Card.IsTarget;
