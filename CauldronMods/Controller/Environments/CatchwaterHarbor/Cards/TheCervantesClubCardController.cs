...
namespace Cauldron.CatchwaterHarbor
{
    public class TheCervantesClubCardController : CatchwaterHarborUtilityCardController
    {
        ...
        private IEnumerator EndOfTurnResponse(PhaseChangeAction arg)
        {
            ...
            IEnumerator coroutine = GameController.SelectCardsAndStoreResults(DecisionMaker, SelectionType.GainHP, (Card c) => c.IsHeroCharacterCard && !c.IsIncapacitatedOrOutOfGame && GameController.IsCardVisibleToCardSource(c, GetCardSource()), 1, storedResults, false, cardSource: GetCardSource());
