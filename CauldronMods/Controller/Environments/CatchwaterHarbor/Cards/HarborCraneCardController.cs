...
namespace Cauldron.CatchwaterHarbor
{
    public class HarborCraneCardController : CatchwaterHarborUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DealDamageAction>((DealDamageAction dd) => dd.Target == Card && dd.DamageSource != null && dd.DamageSource.Card != null && dd.DamageSource.Card.IsTarget && !dd.DamageSource.IsSameCard(dd.Target) && !IsThisCardNextToCard(dd.DamageSource) && dd.DidDealDamage, NextToResponse, TriggerType.MoveCard, TriggerTiming.After);

            //Increase damage dealt by the target next to this card by 1.
            AddIncreaseDamageTrigger((DealDamageAction dd) => dd.DamageSource != null && GetCardThisCardIsNextTo() != null && dd.DamageSource != null && dd.DamageSource.Card != null && dd.DamageSource.Card == GetCardThisCardIsNextTo(), 1);
