...
namespace Cauldron.CatchwaterHarbor
{
    public class HarborCraneCardController : CatchwaterHarborUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DealDamageAction>((DealDamageAction dd) => dd.Target == Card && dd.DamageSource.Card.IsTarget && !dd.DamageSource.IsSameCard(dd.Target) && !IsThisCardNextToCard(dd.DamageSource) && dd.DidDealDamage, NextToResponse, TriggerType.MoveCard, TriggerTiming.After);
