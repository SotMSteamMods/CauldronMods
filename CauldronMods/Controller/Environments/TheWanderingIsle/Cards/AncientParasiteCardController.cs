...
namespace Cauldron.TheWanderingIsle
{
    public class AncientParasiteCardController : TheWanderingIsleCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction dd) => dd.Target == this.Card && dd.DamageSource.Card.IsTarget && dd.DamageSource.Card.IsHero && !IsThisCardNextToCard(dd.DamageSource) && dd.DidDealDamage, this.NextToResponse, new TriggerType[] { TriggerType.MoveCard }, TriggerTiming.After);
