...
namespace Cauldron.DungeonsOfTerror
{
    public class HighGroundCardController : DungeonsOfTerrorUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddReduceDamageTrigger((DealDamageAction dd) => IsTopCardOfLocationFate(TurnTaker.Trash) == true && dd.DamageSource.IsHeroTarget && dd.DamageSource.IsTarget,(DealDamageAction dd) => 1);
