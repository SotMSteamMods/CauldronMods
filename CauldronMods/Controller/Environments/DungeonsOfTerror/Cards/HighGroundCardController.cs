...
namespace Cauldron.DungeonsOfTerror
{
    public class HighGroundCardController : DungeonsOfTerrorUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddReduceDamageTrigger((DealDamageAction dd) => IsTopCardOfLocationFate(TurnTaker.Trash) == true && dd.DamageSource.IsHero && dd.DamageSource.IsTarget,(DealDamageAction dd) => 1);
