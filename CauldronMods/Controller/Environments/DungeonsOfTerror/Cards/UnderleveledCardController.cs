...
namespace Cauldron.DungeonsOfTerror
{
    public class UnderleveledCardController : DungeonsOfTerrorUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddIncreaseDamageTrigger((DealDamageAction dd) => IsTopCardOfLocationFate(TurnTaker.Trash) != null && IsTopCardOfLocationFate(TurnTaker.Trash).Value == true && dd.DamageSource.IsVillainTarget, (DealDamageAction dd) => 1);

            //While it is not a fate card, increase damage dealt by hero targets by 1.
            AddIncreaseDamageTrigger((DealDamageAction dd) => IsTopCardOfLocationFate(TurnTaker.Trash) != null && IsTopCardOfLocationFate(TurnTaker.Trash).Value == false && dd.DamageSource.IsHero && dd.DamageSource.IsTarget, (DealDamageAction dd) => 1);
