...
namespace Cauldron.TheInfernalChoir
{
    public class EclipseCardController : TheInfernalChoirUtilityCardController
    {
        ...
        private IEnumerator EndOfTurnDamage()
        {
            ...
            var coroutine = GameController.DetermineTurnTakersWithMostOrFewest(true, 1, 1, tt => tt.IsHero, tt => tt.Trash.NumberOfCards, SelectionType.DealDamage, result, cardSource: GetCardSource());
