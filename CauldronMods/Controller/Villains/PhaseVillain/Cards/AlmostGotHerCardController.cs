...
namespace Cauldron.PhaseVillain
{
    public class AlmostGotHerCardController : PhaseVillainCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction action) => !base.HasBeenSetToTrueThisRound(FirstTimeDealDamage) && action.DamageSource != null && action.DamageSource.Card != null && action.DamageSource.Card == base.CharacterCard && IsHeroTarget(action.Target), this.FirstTimeDealDamageResponse, TriggerType.IncreaseDamage, TriggerTiming.After);
