...
namespace Cauldron.Mythos
{
    public class RitualSiteCardController : MythosUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddIncreaseDamageTrigger((DealDamageAction action) => base.IsTopCardMatching(base.MythosDangerDeckIdentifier) && action.DamageSource.IsEnvironmentCard && action.Target.IsHero, 1);

            //{MythosMadness} At the end of the villain turn, this card deals each hero target 1 psychic damage.
            base.AddEndOfTurnTrigger((TurnTaker tt) => tt == base.TurnTaker, this.MadnessDealDamageResponse, TriggerType.DealDamage, (PhaseChangeAction action) => base.IsTopCardMatching(base.MythosMadnessDeckIdentifier));
        }
