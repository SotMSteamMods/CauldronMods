...
namespace Cauldron.Mythos
{
    public class HallucinatedHorrorCardController : MythosUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction action) => action.DidDealDamage && IsHeroCharacterCard(action.Target) && action.DamageSource != null && action.DamageSource.Card != null && action.DamageSource.IsHeroTarget && action.Target != action.DamageSource.Card, base.DestroyThisCardResponse, TriggerType.DestroySelf, TriggerTiming.After);
        }
    }
}
