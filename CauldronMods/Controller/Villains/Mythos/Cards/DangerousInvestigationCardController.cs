...
namespace Cauldron.Mythos
{
    public class DangerousInvestigationCardController : MythosUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddEndOfTurnTrigger((TurnTaker tt) => tt == base.TurnTaker, this.ClueResponse, TriggerType.PlayCard, (PhaseChangeAction action) => base.IsTopCardMatching(MythosEyeDeckIdentifier));
