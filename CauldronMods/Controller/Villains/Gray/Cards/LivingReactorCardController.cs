...
namespace Cauldron.Gray
{
    public class LivingReactorCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction action) => action.Target.IsHero && action.DamageSource.Card == base.CharacterCard && !action.IsPretend && action.IsSuccessful, IncreaseOrDiscardResponse, new TriggerType[] { TriggerType.IncreaseDamage, TriggerType.DiscardCard }, TriggerTiming.Before);
        }
