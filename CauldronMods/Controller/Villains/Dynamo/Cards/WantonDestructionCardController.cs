...
namespace Cauldron.Dynamo
{
    public class WantonDestructionCardController : DynamoUtilityCardController
    {
        ...
        private IEnumerator DestroyCardsResponse(PhaseChangeAction action)
        {
            ...
            IEnumerator coroutine = base.EachPlayerDestroysTheirCards(new LinqTurnTakerCriteria((TurnTaker tt) => tt.IsHero), new LinqCardCriteria((Card c) => true), requiredNumberOfCards: 0, storedResults: destroyCardActions);
